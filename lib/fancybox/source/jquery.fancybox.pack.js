...
(function (window, document, $, undefined) {
  ...
  var defaults = {
    ...
    btnTpl: {
      download: '<a download data-fancybox-download class="fancybox-button fancybox-button--download" title href="javascript:;" target="_blank" rel="noopener">' +
    ...
    create: function () {
      ...
      $.each(instance.group, function (i, item) {
        ...
        list.push(
          ...
          i +
          '" ' + (src && src.length ? style="background-image:url(' + src + ')" : 'class="fancybox-thumbs-missing" ') " target="_blank" rel="noopener"></a>"
        );
      });
  ...
  $.extend(true, $.fancybox.defaults, {
    ...
    share: {
      ...
      tpl: '<div class="fancybox-share">' +
        "<h1></h1>" +
        "<p>" +
        '<a class="fancybox-share__button fancybox-share__button--fb" href="https://www.facebook.com/sharer/sharer.php?u=" target="_blank" rel="noopener">' +
        '<svg viewbox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path d="m287 456v-299c0-21 6-35 35-35h38v-63c-7-1-29-3-55-3-54 0-91 33-91 94v306m143-254h-205v72h196"/></svg>' +
        "<span>Facebook</span>" +
        "</a>" +
        '<a class="fancybox-share__button fancybox-share__button--tw" href="https://twitter.com/intent/tweet?url=&text=" target="_blank" rel="noopener">' +
        '<svg viewbox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path d="m456 133c-14 7-31 11-47 13 17-10 30-27 37-46-15 10-34 16-52 20-61-62-157-7-141 75-68-3-129-35-169-85-22 37-11 86 26 109-13 0-26-4-37-9 0 39 28 72 65 80-12 3-25 4-37 2 10 33 41 57 77 57-42 30-77 38-122 34 170 111 378-32 359-208 16-11 30-25 41-42z"/></svg>' +
        "<span>Twitter</span>" +
        "</a>" +
        '<a class="fancybox-share__button fancybox-share__button--pt" href="https://www.pinterest.com/pin/create/button/?url=&description=&media=" target="_blank" rel="noopener">' +
...
})(document, jQuery);</":></div></-></=></=></div></div></div>